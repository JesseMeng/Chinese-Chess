...
public class Board extends JPanel implements MouseListener{
	...
	public void paint(Graphics g1){
		...
		g.setColor(Color.black);
		Font font1 = new Font("宋体",Font.BOLD,50);//font
		g.setFont(font1);
						...
						if(pieces[i][j].getColor() == pieces[startX][startY].getColor()){//my piece
							...
							if(canMove){
								try{
								    ...
								    if(pieces[endX][endY].getName().equals("帥") || pieces[endX][endY].getName().equals("將")){
								    	this.win();
								    }
								    else{
								    	this.gameNotEnd();
	...
	public void move(int startI,int startJ,int endX,int endY){
		if(pieces[endX][endY] != null && (pieces[endX][endY].getName().equals("帥") || pieces[endX][endY].getName().equals("將"))){//if king is dead
